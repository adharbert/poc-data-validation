...
BEGIN TRY
    ...
    ;WITH source AS (
        SELECT *
        FROM (VALUES
			(CAST('3CFDCADA-ADC0-F011-B692-A0B339B26E42' AS UNIQUEIDENTIFIER), 'University of Florida Test'				    , 'University of Florida Board of Trustees'	            , 'Florida Gators '		                , 'UFTST'	, 'UF7K9P2M4Q8R5T1V3W6YX9Z0B2', 'https://www.ufl.edu/'		        , '3523923261', 'FloridaGators@mailinator.com'	, CAST(1 AS BIT), CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH', CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH'),
			(CAST('3DFDCADA-ADC0-F011-B692-A0B339B26E42' AS UNIQUEIDENTIFIER), 'University of St Thomas Minnesota Test'	    , 'University of St Thomas'	                            , 'We Are Thommies'		                , 'USTTST'	, 'UST3F8H1J5L9N2P4Q7R0T6U8V1', 'https://www.stthomas.edu/'		    , '6519625000', 'USTMN@mailinator.com'		    , CAST(1 AS BIT), CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH', CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH'),
			(CAST('3EFDCADA-ADC0-F011-B692-A0B339B26E42' AS UNIQUEIDENTIFIER), 'The Cleveland Clinic Foundation Test'	    , 'The Cleveland Clinic Foundation'				        , 'Cleveland Clinic'	                , 'CCFTST'	, 'CCF9V04GSASKGWYWJJNXR2Y3ES', 'https://my.clevelandclinic.org/'	, '8002232273', 'testCCF@mailinator.com'		, CAST(1 AS BIT), CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH', CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH'),
			(CAST('3FFDCADA-ADC0-F011-B692-A0B339B26E42' AS UNIQUEIDENTIFIER), 'Bethel University Test'					    , 'Bethel University'							        , 'Bethel University'	                , 'BETST'   , 'BETHU04GSAUMS5YWJJNXR2Y3ES', 'https://www.bethel.edu/'			, '6516366400', 'testbu@mailinator.com'			, CAST(0 AS BIT), CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH', CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH'),
			(CAST('40FDCADA-ADC0-F011-B692-A0B339B26E42' AS UNIQUEIDENTIFIER), 'Phi Kappa Sigma Test'			            , 'Phi Kappa Sigma Fraternity Grand Chapter'	        , 'Once a Phi Kap, Always a Phi Kap'	, 'PKSTST'	, 'PKS9A2C4E6G8J1K3M5P7R0T2V4', 'https://pks.org/'		            , '4632005200', 'PKSTest@mailinator.com'	    , CAST(1 AS BIT), CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH', CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH'),
			(CAST('41FDCADA-ADC0-F011-B692-A0B339B26E42' AS UNIQUEIDENTIFIER), 'Military Order of the Purple Heart Test'    , 'MOPH of the United States of America, Incorporated'	, 'MOPH'		                        , 'MOPHST'  , 'QET5B7D9F2H4J6L8N1P3R5T0V2', 'https://www.purpleheart.org/'	    , '7036425360', 'MOPHtest@mailinator.com'       , CAST(1 AS BIT), CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH', CAST('2025-11-13 16:28:59.107' AS DATETIME), 'ADH')
        ) AS s (
